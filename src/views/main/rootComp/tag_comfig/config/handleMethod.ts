import { queryGet, queryPost, queryPut } from "@/service/main/main"
...
export async function createPopupComfirm() { // 🔺新建商品标签
...
export async function editorPopupComfirm() { // 🔺修改商品标签
    const formData = store.popupFormData // 获取 popup 表单要提交的数据 formData
