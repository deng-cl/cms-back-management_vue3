...
<template>
    <div class="user">
        <mainPageSearch :formOptions="formOptions" :formData="payload" :search="search" :reset="reset">高级检索
        </mainPageSearch>
        <mainPageContent title="商家列表" :table-config="tableConfig" :table-data="tableData"
            :pagination-config="paginationConfig" :handle-button-config="handleButtonConfig">
